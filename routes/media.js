...
const { cloudinary, getMainUploadAuth, housekeepingCloudinaryAuth, CLOUDINARY_ACCOUNTS } = require("../middleware/upload");

// TEMP diagnostic — reports each configured Cloudinary account's usage %
// without exposing any credentials. Remove after checking.
router.get(
  "/_debug-cloudinary-usage",
