...
const RESERVE_CLUB_FORMS = [
  {
    ...
    label: "Room 1 & 2 Form",
    checkpoints: [
      photo("Bed Pic (Room-1)"),
      photo("Tea Table Pic (Room-1)"),
      photo("Dustbin Pic (Room-1)"),
      photo("Mirror Cabinet (Room-1)"),
      photo("WC (Room-1 Washroom)"),
      photo("Washbasin+Mirror (Room-1 Washroom)"),
      photo("Bed Pic (Room-2)", { required: false }),
      photo("Tea table (Room-2)", { required: false }),
      photo("Dustbin (Room-2)", { required: false }),
      photo("Mirror cabinet (Room-2)", { required: false }),
      photo("WC (Room 2 Washroom)", { required: false }),
      photo("Washbasin+Mirror (Room-2 Washroom)", { required: false }),
      photo("Floor"),
    ],
  },
  {
